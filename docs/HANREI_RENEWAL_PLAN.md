...
次回以降の候補：処分性（大田区ごみ焼却場・土地区画整理事業計画・保育所廃止条例）／原告適格（主婦連ジュース・もんじゅ）／裁量（伊方原発・個人タクシー。マクリーンは収録済み）／国賠1条（筑豊じん肺）／国賠2条（大東水害・国道43号線）／損失補償（河川附近地制限令）。検索需要と既存教材からの内部リンクを基準に5件単位で追加する。
