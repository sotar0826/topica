...
- **応用編バッチ1（5本）すべて公開済み**（2026-07-12。`uttae-ruikei-ouyou`・`soshou-yoken-ouyou`・`tojisha-tekikaku-ouyou`・`benron-shugi-ouyou`・`jihaku-ouyou`）。照合済み判例6件：①別訴で訴訟物となっている債権を自働債権とする相殺の抗弁の可否＝最判平3.12.17（民集45巻9号1435頁・id 52737／`uttae-ruikei-ouyou`）②遺言者生前の遺言無効確認の訴えの適否＝最判昭31.10.4（民集10巻10号1229頁・id 57636／`soshou-yoken-ouyou`）③敷金返還請求権（条件付き権利）の確認の利益＝最判平11.1.21（民集53巻1号1頁・id 52573／`soshou-yoken-ouyou`）④入会団体の総有権確認訴訟の原告適格＝最判平6.5.31（民集48巻4号1065頁・id 52488／`tojisha-tekikaku-ouyou`）⑤権利移転経過の認定（既照合の最判昭41.4.12を深掘り再利用）／`benron-shugi-ouyou`⑥間接事実の自白は自白した当事者を拘束しない＝最判昭41.9.22（民集20巻7号1392頁・id 53988／`jihaku-ouyou`）。全件`get`で事件番号・裁判要旨まで確認。指示書メモの訂正1件：`soshou-yoken-ouyou`向け「遺言者生存中の遺言無効確認＝平11.6.11」は誤りで、同日付は`sozoku-shonin-ouyou`既出の遺産分割協議事件（id 52217）のみと判明。改めて別日付を探索し最判昭31.10.4（id 57636）を新規特定して採用。次は応用編バッチ2（残り5本：`shomei-sekinin`・`kihanryoku`・`kihanryoku-hani`・`ichibu-seikyu`・`kyodo-soshou`）から
